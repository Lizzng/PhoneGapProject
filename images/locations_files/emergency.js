...
(function ($) {
    EmergencyNotices = {
        ...
        init: function (attrs) {
            ...
            var checkBanner = $.getJSON((url.indexOf("?") >= 0 ? url : url + '?ver=' + random), function (data) {
                ...
                if (data.notices.length >= 1) {
                    ...
                    for (i = 0; i < data.notices.length - 1; i++) {
                        ...
                        //console.log(data.notices, idsInUse, i);
                        //console.log(noticeOnPage);
                        //console.log(noticeInCookie, noticesOnPage);
                        //console.log(isEmergency, EmCookieSet);
            ...
            setTimeout(function () {
                $this.init(attrs);
            }, 30000); // Modify this number to change how often the json file is polled
        }
    }
