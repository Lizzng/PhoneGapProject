...
"resource": {
  ...
  "predicates":[{
      ...
      "function":"_cn",
      "arg0":["macro",2],
      "arg1":"international.city@tudublin.ie"
    },{
      "function":"_eq",
      "arg0":["macro",0],
      "arg1":"gtm.click"
      ...
      "function":"_cn",
      "arg0":["macro",2],
      "arg1":"arnaud.teyssou@tudublin.ie"
    },{
      "function":"_cn",
      "arg0":["macro",2],
      "arg1":"agnieszka.kasprzak@tudublin.ie"
    },{
      "function":"_cn",
      "arg0":["macro",2],
      "arg1":"bing.wu@tudublin.ie"
    },{
      "function":"_cn",
      "arg0":["macro",2],
      "arg1":"robert.flood@tudublin.ie"
    },{
      "function":"_cn",
      "arg0":["macro",2],
      "arg1":"andrea.ryan@tudublin.ie"
    },{
      "function":"_cn",
      "arg0":["macro",2],
      "arg1":"sarah.woods@tudublin.ie"
    },{
      "function":"_cn",
      "arg0":["macro",2],
      "arg1":"lida.hughes@tudublin.ie"
    },{
      "function":"_cn",
      "arg0":["macro",2],
      "arg1":"stella.browne@tublin.ie"
    }],
  "rules":[
    [["if",0],["add",0,10,11,12,13,14,15,16,17,18]],
    [["if",1,2],["add",1]],
    [["if",2,3],["add",2]],
    [["if",2,4],["add",3]],
    [["if",2,5],["add",4]],
...
var Kd=[C.B,C.J],Ld=function(a){var b=a[C.Pd];b&&D(40);var c=a[C.Qd];c&&D(41);for(var d=Fa(b)?b:[b],e=0;e<d.length;++e)for(var f in a)if(a.hasOwnProperty(f)&&f!==C.Pd&&f!==C.Qd)if(-1<Ga(Kd,f)){var h=f,k=a[f],l=d[e];vd().set(h,k,l,"IE","IE-D",c)}else{}},Md=function(a,b){for(var c in a)if(a.hasOwnProperty(c))if(-1<
...
var Ch=function(){var a=!1;return a},Eh=function(a){var b=$e("gtm.allowlist")||$e("gtm.whitelist");b&&D(9);Ch()&&(b="google gtagfl lcl zone oid op".split(" "));var c=b&&fb(Va(b),zh),d=$e("gtm.blocklist")||
...
"gtm.init",c));qm=!0}var d=!1;if(d&&!pm&&vm()){var e={};om.unshift((e.event="gtm.init_consent",e));pm=!0}rm=!0;delete Xe.eventModel;Ze();var f=om.shift();if(null!=f){var h=mm(f);
...
Z.g.f=["google"],function(){(function(a){Z.__f=a;Z.__f.h="f";Z.__f.i=!0;Z.__f.priorityOverride=0})(function(a){var b=Ym("gtm.referrer",1)||H.referrer;return b?a.vtp_component&&"URL"!=a.vtp_component?ie(ke(String(b)),a.vtp_component,a.vtp_stripWww,a.vtp_defaultPages,a.vtp_queryKey):Xm(String(b)):String(b)})}();
Z.g.cl=["google"],function(){function a(b){var c=b.target;if(c){var d=wl(c,"gtm.click");Zm(d)}}(function(b){Z.__cl=b;Z.__cl.h="cl";Z.__cl.i=!0;Z.__cl.priorityOverride=0})(function(b){if(!dn("cl")){var c=W("document");kd(c,"click",a,!0);en("cl")}I(b.vtp_gtmOnSuccess)})}();

Z.g.u=["google"],function(){var a=function(b){return{toString:function(){return b}}};(function(b){Z.__u=b;Z.__u.h="u";Z.__u.i=!0;Z.__u.priorityOverride=0})(function(b){var c;c=(c=b.vtp_customUrlSource?b.vtp_customUrlSource:Ym("gtm.url",1))||Vm();var d=b[a("vtp_component")];if(!d||"URL"==d)return Xm(String(c));var e=ke(String(c)),f;if("QUERY"===d)a:{var h=b[a("vtp_multiQueryKeys").toString()],k=b[a("vtp_queryKey").toString()]||"",l=b[a("vtp_ignoreEmptyQueryParam").toString()],n;h?Fa(k)?n=k:n=String(k).replace(/\s+/g,
...
Z.g.ua=["google"],function(){function a(p){return Nd(p)}function b(p,r){var u=!1;if(Ed()&&!u&&!e[p]){var t=function(){var v=fi(),x="gtm"+Ue(),z=n(r),w={name:x};l(z,w,!0);v("create",p,w);v(function(){v.remove(x)})};Id(t,C.J);Id(t,C.B);e[p]=!0}}var c,d={},e={},f={name:!0,clientId:!0,sampleRate:!0,siteSpeedSampleRate:!0,alwaysSendReferrer:!0,allowAnchor:!0,
...
l=function(p,r,u){var t=0;if(p)for(var v in p)if(!k[v]&&p.hasOwnProperty(v)&&(u&&f[v]||!u&&void 0===f[v])){var x=h[v]?Sa(p[v]):p[v];"anonymizeIp"!=v||x||(x=void 0);r[v]=x;t++}return t},n=function(p){var r={};p.vtp_gaSettings&&m(On(p.vtp_gaSettings.vtp_fieldsToSet,"fieldName","value"),r);m(On(p.vtp_fieldsToSet,"fieldName","value"),r);Nd(C.J)||(r.storage="none");Nd(C.B)||(r.allowAdFeatures=!1,r.storeGac=!1);Ok()||(r.allowAdFeatures=!1);Nk()||(r.allowAdPersonalizationSignals=!1);p.vtp_transportUrl&&
(r._x_19=p.vtp_transportUrl);return r},
q=function(p){function r(ea,U){void 0!==U&&E("set",ea,U)}var u={},t={},v={},x={};if(p.vtp_gaSettings){var z=p.vtp_gaSettings;m(On(z.vtp_contentGroup,"index","group"),t);m(On(z.vtp_dimension,"index","dimension"),v);m(On(z.vtp_metric,"index","metric"),x);var w=m(z);w.vtp_fieldsToSet=void 0;w.vtp_contentGroup=void 0;w.vtp_dimension=void 0;w.vtp_metric=void 0;p=m(p,w)}m(On(p.vtp_contentGroup,"index","group"),t);m(On(p.vtp_dimension,"index","dimension"),v);m(On(p.vtp_metric,"index","metric"),x);var y=
n(p),A=hi(p.vtp_functionName);if(Ca(A)){var B="",F="";p.vtp_setTrackerName&&"string"==typeof p.vtp_trackerName?""!==p.vtp_trackerName&&(F=p.vtp_trackerName,B=F+"."):(F="gtm"+Ue(),B=F+".");var E=function(ea){var U=[].slice.call(arguments,0);U[0]=B+U[0];A.apply(window,U)},J=function(ea,U){return void 0===U?U:ea(U)},M=function(ea,U){if(U)for(var Ka in U)U.hasOwnProperty(Ka)&&E("set",ea+Ka,U[Ka])},N=function(){},P={name:F};l(y,P,!0);var ka=p.vtp_trackingId||u.trackingId;A("create",ka,P);E("set","&gtm",uj(!0));var Q=!1;
Ed()&&!Q&&(E("set","&gcs",Od()),b(ka,p));y._x_19&&(null==dd&&delete y._x_19,y._x_20&&!d[F]&&(d[F]=!0,A(mi(F,String(y._x_20)))));p.vtp_enableRecaptcha&&E("require","recaptcha","recaptcha.js");(function(ea,U){void 0!==p[U]&&E("set",ea,p[U])})("nonInteraction","vtp_nonInteraction");M("contentGroup",t);M("dimension",v);M("metric",x);var K={};l(y,K,!1)&&E("set",K);var T;
p.vtp_enableLinkId&&E("require","linkid","linkid.js");E("set","hitCallback",function(){var ea=y&&y.hitCallback;Ca(ea)&&ea();p.vtp_gtmOnSuccess()});var V=function(ea,U){return void 0===p[ea]?u[U]:p[ea]};if("TRACK_EVENT"==p.vtp_trackType){p.vtp_enableEcommerce&&(E("require","ec","ec.js"),N());var la={hitType:"event",eventCategory:String(V("vtp_eventCategory","category")),eventAction:String(V("vtp_eventAction","action")),eventLabel:J(String,
V("vtp_eventLabel","label")),eventValue:J(Pa,V("vtp_eventValue","value"))};l(T,la,!1);E("send",la);}else if("TRACK_SOCIAL"==p.vtp_trackType){}else if("TRACK_TRANSACTION"==
...
(E("require","ec","ec.js"),N());if(p.vtp_doubleClick||"DISPLAY_FEATURES"==p.vtp_advertisingFeaturesType){var Ha="_dc_gtm_"+String(p.vtp_trackingId).replace(/[^A-Za-z0-9-]/g,"");E("require","displayfeatures",void 0,{cookieName:Ha})}if("DISPLAY_FEATURES_WITH_REMARKETING_LISTS"==p.vtp_advertisingFeaturesType){var Ya="_dc_gtm_"+String(p.vtp_trackingId).replace(/[^A-Za-z0-9-]/g,"");E("require","adfeatures",{cookieName:Ya})}T?E("send","pageview",T):E("send","pageview");Sa(y.urlPassthrough)&&ji(B)}if(!c){var eb=p.vtp_useDebugVersion?"u/analytics_debug.js":"analytics.js";p.vtp_useInternalVersion&&!p.vtp_useDebugVersion&&(eb="internal/"+eb);c=!0;var xb=ej(y._x_19,"/analytics.js"),Ra=hh("https:","http:","//www.google-analytics.com/"+eb,y&&!!y.forceSSL);O("analytics.js"===eb&&xb?xb:Ra,function(){var ea=
fi();ea&&ea.loaded||p.vtp_gtmOnFailure();},p.vtp_gtmOnFailure)}}else I(p.vtp_gtmOnFailure)};(function(p){Z.__ua=p;Z.__ua.h="ua";Z.__ua.i=!0;Z.__ua.priorityOverride=0})(function(p){Pd(function(){q(p)},
[C.J,C.B])})}();
...
x,v);else{var E=u.vtp_attribute,J=a(t,"element");F=J&&md(J,E)||v||""}return F;case "MD":var M=u.vtp_mdValue,N=b(t,"MD",Om);return M&&N?Rm(N,M)||v:N||v;case "FORM":return f(String(u.vtp_component||"SUBMIT_TEXT"),t,v);default:var P=c(t,x,v);hn(P,"aev",u.vtp_gtmEventId);return P}})}();Z.g.gas=["google"],function(){(function(a){Z.__gas=a;Z.__gas.h="gas";Z.__gas.i=!0;Z.__gas.priorityOverride=0})(function(a){var b=m(a),c=b;c[rb.Ma]=null;c[rb.mg]=null;var d=b=c;d.vtp_fieldsToSet=d.vtp_fieldsToSet||[];var e=d.vtp_cookieDomain;void 0!==e&&(d.vtp_fieldsToSet.push({fieldName:"cookieDomain",value:e}),delete d.vtp_cookieDomain);return b})}();
